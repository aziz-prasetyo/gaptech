<x-app-layout>
    <div class="p-4 sm:ml-64">
        <div class="p-4">
            <p class="text-black font-semibold text-3xl mb-2 dark:text-white">Pesan Pojok Curhat</p>
                ...
                <div class="p-4 bg-white dark:bg-gray-900 relative flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="relative mt-1">
                            ...
                            <form action="{{ route('kontak.search') }}" method="POST">
                                @csrf
                        ...
                        @foreach ($pesan as $g)
                            <tr
                                ...
                                <td class="px-6 py-4 space-x-2 text-center">
                                    <form method="POST" action="{{ route('kontak.destroy', $g->id) }}"
