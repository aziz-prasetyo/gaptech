<x-app-layout>
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-3xl lg:py-20">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit Galeri</h2>
            <form id="article-form" action="{{ route('galeri.update', $galeri->id) }}" method="POST"
                ...
                <div class="grid gap-2 sm:grid-flex-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <textarea id="message" rows="4" name="judul_foto"
                            ...
                            placeholder="Write your thoughts here...">{{ $galeri->judul_foto }}</textarea>
                    </div>
...
<script>
    ...
    function showSweetAlert() {
        return Swal.fire({
            ...
            text: 'Galeri Anda telah berhasil diperbarui.',
            icon: 'success',
