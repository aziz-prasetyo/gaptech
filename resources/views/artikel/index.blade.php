<x-app-layout>
    <div class="p-4 sm:ml-64">
        <div class="p-4">
            <p class="text-black font-semibold text-3xl mb-2 dark:text-white">Artikel</p>
                ...
                <div class="p-4 bg-white dark:bg-gray-900 flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="relative mt-1">
                            ...
                            <form action="{{ route('artikel.search') }}" method="POST">
                                @csrf
                    ...
                    <tbody>
                        @foreach ($artikel as $a)
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    <img src="{{ url('public/Image/' . $a->foto_artikel) }}"
